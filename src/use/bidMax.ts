...
export default function useBidMax (): number {
  ...
  if (playerState.gold == null || playerState.bid == null || playerState.silver == null || playerState.tableau == null || gameState.profiles == null) {
    return 0
  }
  const ten = playerState.tableau.some(scheme => scheme.rank === 10)
