...
export default function effectsTwentyTwo ({
  ...
  const firstPrivateChild = addEvent(privateEvent, 'First, earn the rightmost timeline scheme\'s rank.')
  ...
  const secondPrivateChild = addEvent(privateEvent, 'Second, earn 5 gold for each dungeon scheme.')
